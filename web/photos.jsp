<%-- 
    Document   : photos
    Created on : Sep 2, 2014, 3:30:18 PM
    Author     : vijani
--%>
...
<html>
    <head>
        ...
        <title>Social Network :: Photo Page</title>
...
<div id="content-2">
    <center><h1><font style="color: navy"> Uploaded Photos!</font></h1></center><br>

    <%
        PhotoJpaController pjc = new PhotoJpaController();
        Long userId = loggedUser.getId();
        List<String> photoList = pjc.findPhotos(userId); 
        if (photoList == null) {
